<h2><a href="https://leetcode.com/problems/orderly-queue">1466. Jump Game V</a></h2><h3>Hard</h3><hr><p>Given an array of&nbsp;integers <code>arr</code> and an integer <code>d</code>. In one step you can jump from index <code>i</code> to index:</p>
